...
public class ButtonControl extends WebControl {
    ...
    public static final String INPUT = "//*[@id=\"{0}\"]";
    ...
    public static ButtonControl fromLabel(String label, int index)  {
        ...
        String inputXpath = MessageFormat.format(INPUT, label);
        String input2Xpath = MessageFormat.format(INPUT2, label);
        ...
        String xpath = "((" +
                ...
                "))[" + index +"]"+
                MessageFormat.format(input2Xpath, label) +
                "))[" + index +"]";
